  ...
  <div :class="widgetClasses" class="card">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label fw-bolder fs-3 mb-1">All Quotes</span>
    ...
    <div class="card-body py-3">
      ...
      <div class="table-responsive">
        <!--begin::Table-->
        <table
          class="table table-hover table-row-bordered table-striped table-row-gray-100 align-middle border gs-0 gy-3"
        >
          <!--begin::Table head-->
          <thead>
            <tr class="fw-bolder text-muted">
              ...
              <th class="min-w-140px">Company Name</th>
              <th class="min-w-120px">Product Name</th>
              <th class="min-w-120px">Policy Type</th>
              <th class="min-w-120px">Health Class</th>
              <th class="min-w-120px">Monthly Premium</th>
              <th class="min-w-120px">Annual Premium</th>
              <th class="min-w-120px">Product Note</th>
            </tr>
          </thead>
          <!--end::Table head-->
    ...
    const list = [
      {
        ...
        policyType: "basic",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/16/INDU.png",
        amb: "A+",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/7/DESJ.png",
        amb: "NA",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/4/CANA.png",
        amb: "A+",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/8/EMPI.png",
        amb: "A",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/3/BMOL.png",
        amb: "A",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/5/CAPI.png",
        amb: "NA",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/18/MANU.png",
        amb: "A+",
      ...
      },
      {
        ...
        policyType: "basic",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/12/FORE.png",
        amb: "A",
      ...
      },
      {
        ...
        policyType: "enhanced",
        company_logo:
          "http://localhost:3000/uploads/core/company/logo/1/ASSU.png",
        amb: "A-",
